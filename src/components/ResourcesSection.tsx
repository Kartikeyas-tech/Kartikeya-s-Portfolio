                ...
                >
                  <div>
                    <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-2 sm:gap-3 mb-2.5">
                      ...
                      <span className={`font-mono text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-md border self-start max-w-full text-wrap leading-snug ${badgeStyle}`}>
                        {cert.costPill}
                      </span>
                    </div>
